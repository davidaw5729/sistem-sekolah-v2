...
@section('content') <div class="mb-8 flex items-end justify-between border-b border-[#E5E3DB] pb-5"> <div> <p class="mb-1 text-[11px] uppercase tracking-[0.2em] text-[#A16207]">Tahun Ajaran 2025/2026</p> <h1 class="font-display text-3xl font-semibold text-[#16213A]">Daftar Guru</h1> </div>
                ...
                <tr class="border-b border-[#EFEDE6] hover:bg-[#FAF9F5]">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex justify-end gap-4 text-xs font-medium">
                            ...
                            <form
                                action="{{ route('teachers.destroy', ['id' => $teacher['id']]) }}"
                                method="POST"
