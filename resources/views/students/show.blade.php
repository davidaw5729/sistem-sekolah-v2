...
@section('content')
    ...
    <div class="mt-3 border border-[#E5E3DB] bg-white">
        ...
        <div class="flex justify-end gap-4 border-t border-[#E5E3DB] px-8 py-5">
            <a href="" class="px-4 py-2.5 text-sm font-medium text-slate-500 hover:text-[#16213A]">Kembali</a <form
                action="" method="POST" onsubmit="return confirm('Hapus data siswa ini dari buku induk?')">
            @csrf
            @method('DELETE')
            <button type="submit"
